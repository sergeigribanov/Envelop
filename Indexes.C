void Indexes(TString path, TString MultidimFitFile = "higgsCombineTest.MultiDimFit.mH120.root"){
   ...
   tr->Draw("pdf_index_cat0:pdf_index_cat1:pdf_index_cat2:pdf_index_cat3:pdf_index_cat4:pdf_index_cat5:pdf_index_cat6:pdf_index_cat7:pdf_index_cat8:pdf_index_cat9:pdf_index_cat10:pdf_index_cat11:pdf_index_cat12:pdf_index_cat13","","PARA goff");
...
//      cout<<st(st.Last('_')+1,st.Length()); // 1D case
   ...
   cout<<"TString funcname[14]["<<MaxInd<<"]={"<<endl;   
   for(int i=0;i<NCAT;i++){
      cout<<"{ ";
